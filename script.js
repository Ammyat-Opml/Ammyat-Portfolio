...
(function () {
  ...
  // Hero starfall — decorative falling stars + a few static twinkles.
  // Generated here so positions/speeds vary; skipped under reduced motion.
  var starField = document.querySelector('.hero-stars');
  if (starField && !reduceMotion) {
    var vw = window.innerWidth;
    var fallCount = vw < 680 ? 16 : (vw < 1100 ? 26 : 36);
    var twinkleCount = vw < 680 ? 10 : 18;
